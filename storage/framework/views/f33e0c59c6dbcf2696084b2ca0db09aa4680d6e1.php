...
<?php endif; ?>
<a href="<?php echo e(route('form_criar_serie')); ?>" class="btn btn-dark mb-4">Adicionar</a>
<ul class="list-group">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <span class="d-flex">
            ...
            <form method="post" action="/series/remover/<?php echo e($serie->id); ?>" onsubmit="return confirm('Tem certeza que deseja remover <?php echo e(addslashes($serie->nome)); ?>?')">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alex.cirilo\php-oo\controle-serie\resources\views/series/index.blade.php ENDPATH**/ ?>